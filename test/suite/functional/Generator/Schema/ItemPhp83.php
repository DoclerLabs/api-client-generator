...
class Item implements SerializableInterface, JsonSerializable
{
    ...
    private ?ItemOptionalEnum $optionalEnum = null;

    private ?ItemOptionalIntEnum $optionalIntEnum = null;

    private ?ItemOptionalNullableEnum $optionalNullableEnum = null;

    private ?ItemOptionalNullableIntEnum $optionalNullableIntEnum = null;
     ...
     */
    public function __construct(private readonly int $mandatoryInteger, private readonly string $mandatoryString, private readonly ItemMandatoryEnum $mandatoryEnum, private readonly ItemMandatoryIntEnum $mandatoryIntEnum, private readonly ?ItemMandatoryNullableEnum $mandatoryNullableEnum, private readonly ?ItemMandatoryNullableIntEnum $mandatoryNullableIntEnum, private readonly DateTimeInterface $mandatoryDate, private readonly ?DateTimeInterface $mandatoryNullableDate, private readonly float $mandatoryFloat, private readonly bool $mandatoryBoolean, private readonly array $mandatoryArray, private readonly array $mandatoryArrayWithMinItems, private readonly ItemMandatoryObject $mandatoryObject, private readonly ?MandatoryNullableObjectWithAllOf $mandatoryNullableObjectWithAllOf, private readonly mixed $mandatoryMixed, private readonly MandatoryAnyOf $mandatoryAnyOf, private readonly ?string $mandatoryNullableStringWithMinMaxLength)
    {
    ...
    public function setOptionalEnum(ItemOptionalEnum $optionalEnum): self
    {
    ...
    public function setOptionalIntEnum(ItemOptionalIntEnum $optionalIntEnum): self
    {
    ...
    public function setOptionalNullableEnum(?ItemOptionalNullableEnum $optionalNullableEnum): self
    {
    ...
    public function setOptionalNullableIntEnum(?ItemOptionalNullableIntEnum $optionalNullableIntEnum): self
    {
    ...
    public function getMandatoryEnum(): ItemMandatoryEnum
    {
        return $this->mandatoryEnum;
    }

    public function getMandatoryIntEnum(): ItemMandatoryIntEnum
    {
        return $this->mandatoryIntEnum;
    }

    public function getMandatoryNullableEnum(): ?ItemMandatoryNullableEnum
    {
        return $this->mandatoryNullableEnum;
    }

    public function getMandatoryNullableIntEnum(): ?ItemMandatoryNullableIntEnum
    {
    ...
    public function getMandatoryMixed(): mixed
    {
    ...
    public function getOptionalEnum(): ?ItemOptionalEnum
    {
        return $this->optionalEnum;
    }

    public function getOptionalIntEnum(): ?ItemOptionalIntEnum
    {
        return $this->optionalIntEnum;
    }

    public function getOptionalNullableEnum(): ?ItemOptionalNullableEnum
    {
        return $this->optionalNullableEnum;
    }

    public function getOptionalNullableIntEnum(): ?ItemOptionalNullableIntEnum
    {
    ...
    public function toArray(): array
    {
        ...
        $fields['mandatoryEnum']                           = $this->mandatoryEnum->value;
        $fields['mandatoryIntEnum']                        = $this->mandatoryIntEnum->value;
        $fields['mandatoryNullableEnum']                   = $this->mandatoryNullableEnum?->value;
        $fields['mandatoryNullableIntEnum']                = $this->mandatoryNullableIntEnum?->value;
        $fields['mandatoryDate']                           = $this->mandatoryDate->format(DATE_RFC3339);
        $fields['mandatoryNullableDate']                   = $this->mandatoryNullableDate?->format(DATE_RFC3339);
        ...
        $fields['mandatoryNullableObjectWithAllOf']        = $this->mandatoryNullableObjectWithAllOf?->toArray();
        ...
        if ($this->hasOptionalEnum()) {
            $fields['optionalEnum'] = $this->optionalEnum->value;
        }
        if ($this->hasOptionalIntEnum()) {
            $fields['optionalIntEnum'] = $this->optionalIntEnum->value;
        }
        if ($this->hasOptionalNullableEnum()) {
            $fields['optionalNullableEnum'] = $this->optionalNullableEnum?->value;
        }
        if ($this->hasOptionalNullableIntEnum()) {
            $fields['optionalNullableIntEnum'] = $this->optionalNullableIntEnum?->value;
        }
        if ($this->hasOptionalDate()) {
            $fields['optionalDate'] = $this->optionalDate->format(DATE_RFC3339);
        }
        if ($this->hasOptionalNullableDate()) {
            $fields['optionalNullableDate'] = $this->optionalNullableDate?->format(DATE_RFC3339);
        }
