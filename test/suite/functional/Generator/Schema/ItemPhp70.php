...
class Item implements SerializableInterface, JsonSerializable
{
    ...
    /**
     * @param bool|null $optionalNullableBoolean
     */
    public function setOptionalNullableBoolean($optionalNullableBoolean): self
    {
     ...
     */
    public function setOptionalNullableArray($optionalNullableArray): self
    {
     ...
     * @return bool|null
     */
    public function getOptionalNullableBoolean()
    {
     ...
     * @return string[]|null
     */
    public function getOptionalNullableArray()
    {
