...
class PostResourceByIdRequest implements RequestInterface
{
    ...
    private PostResourceByIdRequestBody $postResourceByIdRequestBody;

    private string $xwsseUsername;

    private string $xwsseSecret;

    public function __construct(int $resourceId, string $contentType, string $xRequestId, int $mandatoryIntegerParameter, string $mandatoryStringParameter, string $mandatoryEnumParameter, DateTimeInterface $mandatoryDateParameter, float $mandatoryFloatParameter, bool $mandatoryBooleanParameter, array $mandatoryArrayParameter, EmbeddedObject $mandatoryObjectParameter, PostResourceByIdRequestBody $postResourceByIdRequestBody, string $xwsseUsername, string $xwsseSecret)
    {
        if ($resourceId < 0) {
        ...
        $this->postResourceByIdRequestBody = $postResourceByIdRequestBody;
