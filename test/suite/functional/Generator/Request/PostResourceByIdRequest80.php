...
class PostResourceByIdRequest implements RequestInterface
{
    ...
    public function __construct(private int $resourceId, private string $contentType, private string $xRequestId, private int $mandatoryIntegerParameter, private string $mandatoryStringParameter, private string $mandatoryEnumParameter, private DateTimeInterface $mandatoryDateParameter, private float $mandatoryFloatParameter, private bool $mandatoryBooleanParameter, private array $mandatoryArrayParameter, private EmbeddedObject $mandatoryObjectParameter, private PostResourceByIdRequestBody $postResourceByIdRequestBody, private string $xwsseUsername, private string $xwsseSecret)
    {
        if ($resourceId < 0) {
