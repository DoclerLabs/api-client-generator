...
use Test\Schema\ResourceMandatoryEnum;
...
class ResourceMapper implements SchemaMapperInterface
{
    ...
    public function toSchema(array $payload): Resource
    {
        ...
        return new Resource($payload['mandatoryInteger'], $payload['mandatoryString'], ResourceMandatoryEnum::from($payload['mandatoryEnum']), new DateTimeImmutable($payload['mandatoryDate']));
    }
}
