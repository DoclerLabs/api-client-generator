...
/**
 * @covers \DoclerLabs\ApiClientGenerator\Output\Copy\Serializer\ContentType\VdnApiJsonContentTypeSerializer
 */
class VdnApiJsonContentTypeSerializerTest extends TestCase
{
    private VdnApiJsonContentTypeSerializer $sut;

    protected function setUp(): void
    {
        $this->sut = new VdnApiJsonContentTypeSerializer();
    }
    ...
    {
        self::assertEquals(VdnApiJsonContentTypeSerializer::MIME_TYPE, $this->sut->getMimeType());
    }
